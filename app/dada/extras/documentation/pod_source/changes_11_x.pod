...
=head3 Mailgun API Support (Experimental)

Mailgun is a third party email sending service, like Amazon SES. For an overview of third party email sending services, see: 

L<https://dadamailproject.com/d/third_party_email_services.pod.html>

Additional information on Mailgun support:

L<https://dadamailproject.com/d/features-mailgun_support.pod.html>

=head2 Bugfixes

=head3  Searching members is broken in v11.21.0 #1171 

L<https://github.com/justingit/dada-mail/issues/1171>

=head3  Plugin: Change List Shortname outdated - does not update many tables #1168 

L<https://github.com/justingit/dada-mail/issues/1168>
...
=head3 Message Archive Search 

Search for message archives has been added to the admin view of the archives in the list control panel. 

=head3 Message Archive Pagination

L<https://github.com/justingit/dada-mail/issues/1127>

Pagination has been added to the user view of messages archives, including search. Along with pagination being a nice-to-have feature, 
since search results were not pagination in past versions, queries could have been returned with an incredible amount of search results to be shown on the single screen. This realistically could have been a detriment to server performance if too many search queries were returned in a small amount of time. 

Pagination has also been added to the admin view of the messag archives in the list control panel, including search. 

=head3 reCAPTCHA protection on the Global Configuration plugin #1155 
...
L<https://github.com/justingit/dada-mail/issues/1155>

=head3 Change DADA::Security::SimpleAuthStringState to use an SQL table/database 
...
Using the new backend should be transparent to the user - nothing extra is required. There will be a new table in the database named, C<dada_simple_auth_str>. 

=head2 Bugfixes

=head3 Scheduled Jobs (cronjobs) don't list all the individual jobs that can be run #1161 

L<https://github.com/justingit/dada-mail/issues/1161>

=head3 List Control Panel Archive Index Screen shows empty interface if no archived messages are available #1162 

L<https://github.com/justingit/dada-mail/issues/1162>

=head3 Screen Cache is cleaned out every time scheduled jobs (cronjob) is ran #1163 

L<https://github.com/justingit/dada-mail/issues/1163>

=head3 Individual archive message screens (public view) aren't always cached #1164

L<https://github.com/justingit/dada-mail/issues/1164>

=head3 "Forward to a Friend" form doesn't have any required fields #1165 

L<https://github.com/justingit/dada-mail/issues/1165>

=head3 Screen, Data Cache is not flushed when installer is run #1166 

L<https://github.com/justingit/dada-mail/issues/1166>
...
=head3 Drag and Drop Image Upload does not support upper case filenames #1147 

L<https://github.com/justingit/dada-mail/issues/1147>

=head3 CSRF is set to "disable" in the "configure security options" section of the installer when installer is revisted #

L<https://github.com/justingit/dada-mail/issues/1132>

=head3 Mailing List:Options speling mistake, "nitch" should be, "niche" #1153 

L<https://github.com/justingit/dada-mail/issues/1153>

=head3 Consider an OPTIMIZE after removing old Tracker analytics #1149

L<https://github.com/justingit/dada-mail/issues/1149>

=head3 Mention IMAP support in Bounce Handler docs #1151 

L<https://github.com/justingit/dada-mail/issues/1151>

=head3 Perl CPAN Module DateTime.pm unable to located in schedule report

L<https://github.com/justingit/dada-mail/issues/1136>

=head3  Add option to hide reCAPTCHA v3 badge #1138 

L<https://github.com/justingit/dada-mail/issues/1138>

=head3 Doc Update: "Advanced Template Syntax" isn't a thing #1154 

L<https://github.com/justingit/dada-mail/issues/1154>

=head3 Check that custom template used in, Appearance Your Mailing List Template has all required tags #831 

L<https://github.com/justingit/dada-mail/issues/831>
...
C<parse_data: unable to open in-memory file handle at...>

See the following issue: 

L<https://github.com/justingit/dada-mail/issues/1135>

=head2 Bugfixes

=head3  One-click unsubscription can't be enabled #1139 

L<https://github.com/justingit/dada-mail/issues/1139>

=head3 Mis-speling in, "Subscribed" Message #1140 

L<https://github.com/justingit/dada-mail/issues/1140>

=head3 bridge - irrecoverable error processing message #1135 

L<https://github.com/justingit/dada-mail/issues/1135>

=head3 Rate Limits should be ignored for logged in administrators when handling unsubscribe requests #1130 

L<https://github.com/justingit/dada-mail/issues/1130>

=head3  Searching a list's message archive in the public view may return 500 error #1141 

L<https://github.com/justingit/dada-mail/issues/1141>
...
L<https://github.com/justingit/dada-mail/blob/main/make_distro.pl>

as well as the new doc on how to build Dada Mail from source, 

L<https://dadamailproject.com/d/building_dada_mail_from_source.pod.html>


=head3 “Bounces” tab in the membership screen
...
=head3 Better Link Pre-fetching Protection 
...
L<https://blog.healthchecks.io/2019/12/preventing-office-365-atp-from-clicking-unsubscribe-links/>

The arms race to stop link pre-fetching continues. 

=head3 Rich Filemanager upgraded to v2.7.6


=head3 DADA::App::HTMLtoMIMEMessage added to Debug Trace Options
...
=head3 Better error reporting for problems with database connections
...
=head2 Data::Google::Visualization::DataTable defaults to using JSON::XS which may not be available

L<https://github.com/justingit/dada-mail/issues/1129>
...
=head3 Enable/Disable mailing list specific email headers
...
Find this feature in, Mailing List: Options labeled, B<Use mailing list headers> (enabled by default).

The list headers you can enable/disable is found in the Config.pm file in the variable, C<$LIST_HEADERS>. Here are the headers that can be enabled/disabled, 
...
=head3 Enhanced HTML editing via "Grab content from a URL"

Dada Mail can grab content for a mailing list message just by giving it a URL. 

You can also crop the webpage to only send the content found in a specific HTML id or class attribute, 
and remove content found in HTML tags that have specific id or class attributes. 

We've enhanced that last feature, by allowing you to set multiple attributes, 
be they HTML ids, classes, or any other HTML attribute found in a tag. 
You can also just remove all instances of any HTML tag. 

Find this option where you edit your draft mailing list messages, under B<Grab content from a URL>. 
The feature itself is labeled, 
B<Remove content found between the following ids, classes, or other attributes:>
...
=head4 Breaking Changes!

In past versions of Dada Mail, either "id" or, "class" had to be picked in a separate text box. 
This text box has been removed now that you can set a id, class, or other attributes in the text box that remains. 
If you are already using this feature (located only for fetching via a Feed URL), you will need to adjust your draft settings. 

=head3 Installer: Ability to Switch the path to the Perl interpreter

Oftentimes (and especially on cPanel-based hosting accounts) there is an alternative Perl interpreter available to use, 
but isn't at the default Perl path that Dada Mail is configured to use. This alternative Perl interpreter could 
be more up to date, and also use the modules that are available to the cPanel-based Perl module installer. 

We've made it easy to switch to this alternative Perl interpreter located. Do note, that there's no way to revert to the 
default Perl interpreter location. You would need to either reinstall Dada Mail from scratch, or manually reset the "shebang lines"
yourself. 

=head3 Upgraded Included Perl Library! (perllib)

Dada Mail comes with most all of the Perl CPAN Perl modules needed to run the app. These modules are located in the, C<dada/DADA/perllib> directory. This collection of CPAN modules was very much out of date, and the exact list of Perl modules shipped wasn't exactly known. 

This has now been fixed, and steps have been taken to make sure that future releases will have an up to date included Perl library. 
The exact modules that are included have been removed from the Dada Mail git repo, and have been made into their own repo: 

L<https://github.com/justingit/dada-mail-perllib>
...
This change will most likely be transparent to most users, but the updates of these modules was huge in terms of code line count, 
and many bug fixes and security fixes within these modules are now bundled with Dada Mail. 

=head3 Cross-Site Request Forgery (CSRF) Prevention can now be disabled
...
Find this within the installer under, B<Configure Security Options: Cross-Site Request Forgery (CSRF) Protection>

We do highly suggest keeping this enabled. 

=head2 Bugfixes

=head3 Grab content from a URL: Auto-generated PlainText version not cropped 

L<https://github.com/justingit/dada-mail/issues/1115>

=head3 Resend Subscription Confirmation via the list control panel broken 

L<https://github.com/justingit/dada-mail/issues/1114> 

=head3 CPAN modules shipped with Dada Mail are outdated and impossible to maintain

L<https://github.com/justingit/dada-mail/issues/1113>

=head3 List Control Panel Archive Screen: message_blurb() call memory leak?

L<https://github.com/justingit/dada-mail/issues/1116>

=head3 Previews of message drafts always show in modal menu and not in new window in Drafts Index

L<https://github.com/justingit/dada-mail/issues/1117>
...
=head3 Plugins: Bridge, append_message_to_file sometimes called with wrong arguments

L<https://github.com/justingit/dada-mail/issues/1112>

=head3 Deleting Stationery/Schedule will create a new Stationery/Schedule and not delete the Stationery/Schedule

L<https://github.com/justingit/dada-mail/issues/1111>

=head3 Plugin: Change List Shortname doesn't work: csrf issues and logout issues 

L<https://github.com/justingit/dada-mail/issues/1110>

=head3 Amazon SES: Remove requirement for, Crypt::SSLeay, add requirement for LWP::Protocol::https

L<https://github.com/justingit/dada-mail/issues/1109>

=head3  Consider Implementing AutoInactiveDestroy

L<https://github.com/justingit/dada-mail/issues/1096>

=head3 Consider implementing DROP TABLE and RENAME TABLE in SQLite backend

L<https://github.com/justingit/dada-mail/issues/1097>
...
=head3 Core 5 File Manager Perl connector/upload script fails to work correctly if you set additional Perl libaries

L<https://github.com/justingit/dada-mail/issues/1108>

=head3 Changing Delivery Preferences (individual, digest, vacation) in Membership: View causes csrf issue

L<https://github.com/justingit/dada-mail/issues/1107>

=head3 "Transform to Pro" feature doesn't work

L<https://github.com/justingit/dada-mail/issues/1106>

=head3  Search Results (including Partial Mailing List Sending) are incorrect if subscriber doesn't have a profile

L<https://github.com/justingit/dada-mail/issues/1105>

=head3 Template sanity check for Send a Webpage

L<https://github.com/justingit/dada-mail/issues/1103>

=head3  suspicious_activity_by_ip_check not working correctly

L<https://github.com/justingit/dada-mail/issues/1100>
...
=head3 Support for libcurl via LWP::Protocol::Net::Curl as the WWW Engine

Dada Mail use the LWP CPAN Perl module for many of functionality, from grabbing webpages to send, to calling web services, like Amazon SES. 
We've added the ability to change the actual WWW Engine from LWP to libcurl via the C<LWP::Protocol::Net::Curl> module. 

In some cases C<LWP> is not configured correctly to allow https connections, but if there's support for C<libcurl>, it could be. 

More Information: 

L<https://metacpan.org/pod/LWP::Protocol::Net::Curl>

L<https://curl.se/>

=head4 Support to set User Agent

=head4 Support to enable/disable hostname verification
...
=head3  "mailbox not found" bounce not parsed correctly #1087

L<https://github.com/justingit/dada-mail/issues/1087>

=head3  Ambiguous Date in Version #1084
...
=head3 Image Drag and Drop into the message editor window will invalidate the session 

L<https://github.com/justingit/dada-mail/issues/1079>

=head3 Core5FileManager does not work with current CSRF enhancements

L<https://github.com/justingit/dada-mail/issues/1080>
...
=head3 Only one mailing list? The default screen is now that list screen

Dada Mail supports an arbitrary number of lists, but many people just run one mailing list. 
If this is the case, Dada Mail will show what is usually shows in the list's own screen on the default screen. 
This saves user's a click to view relevant information of that one list. 

=head3 Multiple mailing lists? Subscription buttons for each mailing list

If you're running Dada Mail with multiple mailing lists, a button to allow a user to subscribe to each mailing list will be available. 
This saves the user a screen refresh to subscribe to the actual mailing list. 

=head3 Schedule Mass Mailings now have an option to send right away

There's a few instances where you have a scheduled mass mailing, and you would like to just send that mass mailing right away. 
Now you can! Look for the button on the top bar labeled, B<Send Mass Mailing Now> in your schedule mailing. 

=head3 Periodic Login/Session Status Check 

Dada Mail now will check your login/session status periodically (every 5 minutes) to make sure it's valid. 
If it's not, you'll be automatically logged out.  

=head3 New option to show/hide a subscription form in the default, list, and archive screens

If you don't want to show a subscription form in your default/list/archives screens, now you don't have to. 
This option is per-list, find it in B<Mailing List: Options>. Look for the option labeled, B<Show subscription form>. Any subscription forms that are available to users will still work. 

=head3 Custom email themes are now automatically kept during upgrading
...
Dada Mail has support to reset the B<List Password> via a confirmation email after an incorrect login. 
You can now disable this functionality in the Dada Mail Installer. 

=head3 plugin: password_protect_directories - option to always use the default password

=head2 Changes

=head3 plugin: password_protect_directories works (again)

This plugin seemed broken beyond all comprehension. It should work again!

=head2 Bugfixes

=head3 Public archives only viewed when logged in with a profile password fails to work 

L<https://github.com/justingit/dada-mail/issues/1078>

This was a regression caused by the changes introduced in v11.16.x

=head3 Custom templates aren't used if used in a, <!-- tmpl_include --> tag 

L<https://github.com/justingit/dada-mail/issues/1077>

=head3  Clicking, "Manually Run All Scheduled Mass Mailings" in a schedule without first saving this schedule will save it as a draft

L<https://github.com/justingit/dada-mail/issues/1076>

=head3 Scheduled Mailings: Looking at Recurring Schedules Calendar for an unsaved schedule will save the schedule as a draft 

L<https://github.com/justingit/dada-mail/issues/1075>

=head3 Potential hidden profile field data lost from subscription form if submitted from captcha-protected form that doesn't have a captcha

L<https://github.com/justingit/dada-mail/issues/1073>

=head3 Bridge: Errors with auto image resizing causes message not to be delivered

L<https://github.com/justingit/dada-mail/issues/1072> 
...
=head3 Tracker reports in mailing monitor causes logout from list control panel

L<https://github.com/justingit/dada-mail/issues/1068>
...
This version of Dada Mail has been released primarily to fix a security vulnerability dealing with B<Enhanced Cross-Site Request Forgery (CSRF)>.

=head3 Enhanced Cross-Site Request Forgery (CSRF) Prevention 
...
=item * CSRF protection to all list control panel screens (including plugins) when logged in

=item * Initial CSRF protection on the actual list control panel login form is enabled by default

This feature was available in Dada Mail, but was not enabled by default

=item * CSRF protection for any a user who logs into their profile would be able to do when logged in

=item * CSRF protection for the initial profile login form

=item * Login cookies for both the list control panel and profiles have the, "SameSite" flag added, and set to, "Lax"

=item * Login cookies for both the list control panel and profiles have the, "secure" flag added, and set to, "1", if the connection is under https

=item * Google reCAPTCHA added to the Change List Password, Change Dada Mail Root Password, Profile login, and Profile Registration 
...
L<https://owasp.org/www-community/attacks/csrf>

v11.16.0 comes with Cross-Site Request Forgery prevention using the B<Double Submit Cookie> pattern: (L<https://cheatsheetseries.owasp.org/cheatsheets/Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.html#double-submit-cookie>). 

To enhance this, we also "HMAC the token with a secret key known only by the server and place this value in a cookie" (as described in the above doc), and set cookies to have, B<SameSite> set to, B<Lax> (instead of not setting SameSite at all), (L<https://cheatsheetseries.owasp.org/cheatsheets/Cross-Site_Request_Forgery_Prevention_Cheat_Sheet.html#samesite-cookie-attribute>), 

=head3 Additional Suggestions to Help Harden Security 

=over

=item * Run Dada Mail under https

Running Dada Mail under https will protect sensitive data from being able to read in transmission. 

=item * Set up Google reCAPTCHA
...
=head3 RESTFUL API supports Global Public/Private Keys, Creating New Mailing Lists
...
L<https://dadamailproject.com/d/features-restful_web_services.pod.html#Global-Public-and-Private-Keys>


=head2 Changes

=head3 Default Membership: View address order is now Date Added/Subscription Date/Descending

Previous order was email address alphabetically/descending

=head2 Bugfixes

=head3 Switching between lists accepts "GET" requests

L<https://github.com/justingit/dada-mail/issues/1067>

=head3 "logout" accepts "GET" requests

L<https://github.com/justingit/dada-mail/issues/1066>

=head3 You can send a mass mailing to no one

L<https://github.com/justingit/dada-mail/issues/1064>
...
L<https://github.com/justingit/dada-mail/issues/1053>

L<https://github.com/justingit/dada-mail/issues/1060>

=head2 Bugfixes

=head3  Creating a new list can be done via a GET request

L<https://github.com/justingit/dada-mail/issues/1061>

=head3 reCAPTCHA v3 check has strangely derefrenced variable in code, likely to cause issues.

L<https://github.com/justingit/dada-mail/issues/1060>

=head3 Logging into the List Control Panel accepts a GET request

L<https://github.com/justingit/dada-mail/issues/1059>

=head3 Dada Mail accepts GET requests to, "Forward to a Friend" form

L<https://github.com/justingit/dada-mail/issues/1058>

=head3 Dada Mail accepts "subscribe" requests via GET

L<https://github.com/justingit/dada-mail/issues/1057>

=head3 Attempting to send to a blank email address during a mass mailing will stall out the mass mailing (SMTP)

L<https://github.com/justingit/dada-mail/issues/1056>

=head3 Google Recaptcha v2 check will return valid if problem with API call happens 
...
This is a release that includes some features as well as some fairly important security enhancements. 
Please read the whole changelog for this release to understand the important changes made. 

=head2 Changes

=head3 jQuery upgraded from v2.2.4 to v3.6.0 

Older versions of jQuery have known potential security issues that have been fixed in newer versions.
No known security exploits in Dada Mail have been found from this older version of jQuery, but we suggest upgrading
your version of Dada Mail to stay as safe as possible.

More information: 

L<https://snyk.io/test/npm/jquery/2.2.4>

=head2 Link Prefetching Protection
...
=item * List Owner Accept/Rejecting Subscriptions

=item * List Password Reset

=item * Clickthrough Link Tracking

=item * Profile Activation

=item * Profile Password Reset

=item * Moderating Discussion Messages
...
=head3 Trying to view the public archive without knowing the list will lead to blank page/error #1047 

L<https://github.com/justingit/dada-mail/issues/1047>
...
=head3 Delete email address from Bounce Scorecard when email address is unsubscribed #1035 

L<https://github.com/justingit/dada-mail/issues/1035>

=head3 Plugins: Tracker - Add a date/timestamp to options for updating profile fields in the preferences #1032 

L<https://github.com/justingit/dada-mail/issues/1032>

=head3 Ping POP3 and IMAP connections before attempting to connect #1029 

L<https://github.com/justingit/dada-mail/issues/1029>

=head2 Bugfixes

=head3  Plugins: Tracker - Sending Speed (messages/hour) aren't rounded to the nearest message, or commified #1039 

L<https://github.com/justingit/dada-mail/issues/1039>

=head3  Amazon SES mass mailing batch sending speed estimates are too optimistic #1038 

L<https://github.com/justingit/dada-mail/issues/1038>

=head3 When manually running schedules (cronjobs) in list control panel, the admin menu items should be updated #1037 

L<https://github.com/justingit/dada-mail/issues/1037>

=head3 Cannot create a new draft message w/MySQL v8.0.2x #1034 

L<https://github.com/justingit/dada-mail/issues/1034>

=head3 Mass Mailing: SMTP sending doesn't return back any errors #1028 

L<https://github.com/justingit/dada-mail/issues/1028>
...
=head3 @LIST_SETUP_DONT_CLONE can't be overridden in .dada_config file

L<https://github.com/justingit/dada-mail/issues/1027>

=head3 RESTful webservices: "mass_email": plain text messages don't send #1026 

L<https://github.com/justingit/dada-mail/issues/1026>

=head3 Remove Net::SMTP_auth from distribution - it isn't used #1025 

L<https://github.com/justingit/dada-mail/issues/1025>

=head3  "Forward to a Friend" form not protected by rate limiting, and it really should

L<https://github.com/justingit/dada-mail/issues/1022>

=head3 Creating a new Draft from a Stationery doesn't redirect you to the newly made Draft Message

L<https://github.com/justingit/dada-mail/issues/1021>
...
=head3 Auto-Remove Old Tracker Data
...
=head3 "Save Draft" button, when pressed, no longer refreshes screen 

When creating a draft, one of the buttons allows you to save the draft. Rather than having to wait for the screen to refresh to continue editing, clicking the B<Save Draft> button will now save your draft in the background and you can keep editing your draft message.  
...
=head3 "Check All/Uncheck All" option added to saving settings to multiple lists
...
=head3 Send a Message: Previewing an unsaved draft will lead to multiple copies of the draft 

L<https://github.com/justingit/dada-mail/issues/1019>
...
=head3 Membership: Recent Activity table of subs/unsub always static at last 100 log lines. Why?

L<https://github.com/justingit/dada-mail/issues/1005>

This was a strange issue - perhaps this is more of a feature. But the chart on the top of, B<Membership: Recent Activity>, and the table on the bottom don't align up. The chart can show months of data, while the table below shows perhaps the only last 100 lines, which could be years of activity, or just a few days of activity. 
...
=head3 Noisy warning in DADA::App::Messages::send_multipart_email (v11.13.0)

L<https://github.com/justingit/dada-mail/issues/1014>

=head3 Bridge: Setup As: Email Forward will not wor

L<https://github.com/justingit/dada-mail/issues/1013>

=head1 11.13.0

=head2 Features

=head3 File Attachments Limit Raised to 10

=head3 URLs in, Mailing List: List Information can now be optionally validated

=head3 Add a Custom Button

You can now add your own button with a custom button label and background color. 

=head3 Grab content from an RSS/Atom feed: set a limit on how old entries can be 
...
=head3 Bridge: Messages that cannot be parsed/processed can be sent to List Owner

Rather than just quietly fail. messages that cannot be parsed/processed can then be sent to the List Owner, who can look over 
what may be the issue. The error produced will also be sent. Enable/Disable this option in Bridge's settings. Look for the option labled, B<When a received message cannot be processed: [x] Send a copy of the message to the List Owner >.

=head2 Bugfixes 

=head3 Plugin: Bridge - "Message too old" check will still send, "Not Allowed to Post" email notifications to list owner/subscriber #1011 

L<https://github.com/justingit/dada-mail/issues/1011>

=head3  List Email can be set as blank in Bridge, but messages can still be sent to the list - no check to make sure List Email is valid? #1004 

L<https://github.com/justingit/dada-mail/issues/1004>

=head3 Speling error in docs: "PlainTest" should be, "PlainText" 

L<https://github.com/justingit/dada-mail/issues/990>

=head3 reCAPTCHA on the initial default screen not come up? #999 

L<https://github.com/justingit/dada-mail/issues/999>

=head3  Subscribers that need to be confirmed by the list owner also show up in the, "unconfirmed subscribers" sublist, even though the confirmed #997 

L<https://github.com/justingit/dada-mail/issues/997>

=head2 Changes

=head3 Mailhide support dropped

=head3 Better SQL Connection Error reporting
...
=head3 Content-Encoding never changed in messages received via Bridge

L<https://github.com/justingit/dada-mail/issues/985>
...
=head3 Image resizing using Image::Scale does not work correctly 

L<https://github.com/justingit/dada-mail/issues/989>

=head3 Recurring schedules that grab content from an outside source (webpage, feed) which fail during constructing and sending still update MD5 

L<https://github.com/justingit/dada-mail/issues/986>

=head3 Content-Encoding never changed in messages received via Bridge

L<https://github.com/justingit/dada-mail/issues/985>

=head3 Recurring Schedules that end many decades into the future are slow to process 

L<https://github.com/justingit/dada-mail/issues/984>
...
=head2 Auto-Image Resizing now available for all mailing list messages 

Resizing images automatically allows you to skip the step of optimizing images for email. 
You may have on hand a high resolution image, 
but that image is most likely going to be too large in both file size and image dimensions to be realistic to be used in an email message. 
Sending it will no doubt blow out any layout/design you have,
and force your subscribers to endure downloading such a large image. 
Sending out an message with large images will also take longer than you most likely would prefer as well. 

Email resizing has been available in Dada Mail, but only for images that were dragged and dropped into the rich text editor, limiting it's utility. 
For example, what if you have a discussion list using the Bridge plugin, and users are sending messages with too-large images that way? 
What if you're grabbing the content of your mass mailing from a URL or a blog's feed? 

Starting with this release, all images that are embedded in a mailing list message will now be resized. 
Look for this and related options in the list control panel under, B<Mass Mailing: Options: Images and Attachments>: 

=head2 Embed images within HTML Messages 

Check this option to embed images (default: checked). Embedded images have a better chance to be shown to your subscribers in their mail reader, 
rather than merely linking to the images - linked images are often times blocked to be shown by your mail reader. 
The more images you embed, the larger the total size of your message. 
Large messages will take longer to send, and longer for your subscribers to to download/view. 

Enter auto-resizing these embedded images: 

=head3  Resize embedded images 

Check this option to resize embdedded images (default: B<checked>). Resizing images can help keep message size low. There's no reason to embed a two meg image, but it's not always obvious how large an image is to some users (nor should it be). 
Dada Mail can now handle this chore for you. 

=head4 Image Width Limit (pixels): 

This is where you can set the image width limit. The default is, B<580 pixels>, which is how wide the main area for your message content is in the included mass mailing layouts are that come with Dada Mail. 
Any image wider will just be responsively shrunk anyways (well, sometimes the results looks way funky),
so there's just no reason to use an image that's wider. 

=head3 Resize drag-and-drop images 

(default: B<checked>). Check this option to resize drag and dropped images, as soon as they're uploaded. Images added to your message in any other way will be resized (if needed) when a message is sent out, so you won't see the resized image in the rich text editor. The original image you dragged/dropped will be saved in Dada Mail's file upload directory, as well as the resized version, when you do this, just in case you want the original image for some reason. 
 
=head3 More on image resizing 
...
If you need to, you can install any (or all!) of these modules separately, or just install/upgrade the B<Bundle::DadaMail> module. 
 
=head3 Message Size

You can now set a limit on how large a mass mailing message can be.
Setting a message size limit helps keep a practical and realistic size to messages, 
so you're not try to send out enormous messages to thousands of people. 
Services like Amazon SES do have a limit on how large an email message can be (10 megabytes)

The default mass mailing size limit is 10 megabytes, which is very, very roomy.
This limit is enabled by default, and covers both messages sent through the list control panel, as well as via Bridge. 
Bridge DOES have it's own soft and max size limits for messages it receives. These limits could be higher than the max message size, and that's OK, as transformations of the message received - like resizing of images, or stripping of attachments could lower the final file size. 

=head3 Mass Mailing Schedules Enhancements

=head4 Week of the Month

You can do set which week of the month a recurring scheduled mailing will be sent on (first, second, third, fourth, or fifth week of the month). 
For example, you may now set a schedule to send your message on only the first Monday of each month - a message sent once a month, rather than 4/5 times a month. 

=head4 Scheduled Mass Mailing Preview Calendar

To help understand when scheduled messages will be sent out, a calendar can now be access that shows when a mass mailing should go out. 
Click on the button labeled, B<Save + View Recurring Schedule in Calendar>. The calendar will be shown in a separate window. 

=head3 Mass Mailing from RSS/Atom feed enhancements 

Dada Mail can create a mass mailing from a feed that is produced by something like a blog. 

There may be content of the feed that you would rather not have part of the message, 
and now you may specific which parts you'd like to skip over. Check the option, 
B<Remove content found between the following id/class: >

Then select either a class or id to look for, and the name of those id's or classes. 

=head3 Moderation Enhancements

Discussion messages in Dada Mail can be optionally moderated by a sublist of moderators. 
In this version, the moderator who took action towards the message, either approve the message, or deny the message is noted in the logs. 
This can help answer the question of, "who confirmed/denied this message?!" 
and hopefully stop any fires that started if the decision was critical to some of the other moderators. 

=head2 Changes

=head3 CKEditor Upgraded to, v4.15

=head3 Timezone show in the UI
...
=head3  Former subscriber always receives, "unsubscription successful" email notifications when unsubscriptions are approved

L<https://github.com/justingit/dada-mail/issues/974>

=head3 Selecting, "Send to Testers sublist (n address(es)) " for Drafts, etc does not ever work - tests only go to List Owner

L<https://github.com/justingit/dada-mail/issues/973>

=head3 Comma on the end of line 2462 of Guts.pm is a SQL syntax error

L<https://github.com/justingit/dada-mail/issues/970>

=head3 Saving Settings w/password for multiple lists at once breaks the password

L<https://github.com/justingit/dada-mail/issues/968>
...
=head3 Correct stats for, "bounces" not show in the followup mass mailing analytics email (and probably the mass mailing finished notification email)

L<https://github.com/justingit/dada-mail/issues/966>

=head3 Scheduled mailing list notifications for success/failure always go out, no matter selected preference

L<https://github.com/justingit/dada-mail/issues/965>
...
As a better alternative for, C<Signature4.pm>, you can install it via your favorite CPAN module installer under it's proper name, C<AWS::Signature4>. C<DADA::App::Support::Net::Amazon::SES> is specific to Dada Mail. 
