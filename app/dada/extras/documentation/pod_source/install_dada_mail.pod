...
<div class="row">
	<div class="small-12 medium-8 large-8 medium-centered large-centered columns">	
		<a 
			...
			target="_blank"
			href="https://sourceforge.net/projects/dadamail/files/dada-[VERSION_TAG].tar.gz/download">
	        Download Dada Mail, v11.19.0
		</a> 
...
I<When installing Pro Dada, use B<I<pro_dada-[VERSION_TAG].tar.gz>> as the name of the distribution in these directions.>

=head3 Upload the Dada Mail distribution

Once you have downloaded the Dada Mail distribution ( C<dada-[VERSION_TAG].tar.gz>, upload it to your hosting account.
...
<a 
	class="button success expand" 
	target="_blank"
	href="https://raw.github.com/justingit/dada-mail/[VERSION_TAG]/uncompress_dada.cgi"
>
	uncompress_dada.cgi for v11.19.0 (Save Page/Link As...)
</a>

=end html

and upload the C<uncompress_dada.cgi> script (PlainText/ASCII mode - NOT binary!) to the same directory in your hosting account that you just uploaded, I<dada-[VERSION_TAG].tar.gz>. 

=head3 Change the file permissions of the helper script to, "755"

=head3 Visit the helper script in your web browser

Visiting the C<uncompress_dada.cgi> script should attempt to uncompress the I<dada-[VERSION_TAG].tar.gz> and change the necessary permissions of various files and prep the actual installer for you to use. 
...
<pre>Can't find dada-[VERSION_TAG].tar to uncompress! You may have to uncompress and prep Dada Mail manually.</pre> 
