...
Once the script is done running, two file will be created in the, B<distro> directory. 

Follow the directions at, L<https://dadamailproject.com/d/install_dada_mail.pod.html> to install the app. 
