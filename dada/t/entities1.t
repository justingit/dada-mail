...
use HTML::EntitiesPurePerl qw(decode_entities encode_entities encode_entities_numeric);
...
TODO: {
    local $TODO = 'Don\'t know why this doesn\'t pass?';

    is($a, "VŒre norske tegn b¿r ¾res");
};
