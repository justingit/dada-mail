...
These features are usually entirely optional, meaning Dada Mail will run just fine without them, but your experiene will be greatly enhanced if they are available. 
...
The process of fetching the module and installing it will then commence. Prepare to wait a few minutes, as the process does take a littl time. 
