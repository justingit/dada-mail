...
=head3 Recurring Schedules

Recurring Schedules have been integrated into the core of Dada Mail, having only been available before in the now retired Beatitude plugin. Set a beginning and end date of your mass mailings, the time they should all go out, and the days of the week that they should be sent. 

More information on Schedules, but single and recurring can be found here: 
