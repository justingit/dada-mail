...
This version is primarly a bugfix release, fixing issues found in the v7.4.0 release
...
=item * Sender: header set incorrectly
...
=item * Schedules in the Send a Message screen
...
=head2 Bugfixes 7.4.1 

=head3 New Draft from Stationary

L<https://github.com/justingit/dada-mail/issues/473>
...
Once a message has been scheduled, you may edit the message (and even reuse the schedule, if you would like!). In the list control panel, Go to: I<Mass Mailing - Drafts/Stationary/Schedules>. Click the B<Schedules> tab to view all your schedules. 
