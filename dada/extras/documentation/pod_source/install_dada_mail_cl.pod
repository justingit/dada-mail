...
keep its temporary files, among other things. If you use SQLite for your backend, 
...
The following parameters are required, if you're B<installing> Dada Mail. If you 
are B<upgrading> Dada Mail, there are separate options to make things easier: 
