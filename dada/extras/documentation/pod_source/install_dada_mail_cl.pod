...
Dada Mail is installed/configured using the included installer, either using its 
web-based interface, or the command line interface. The web-based interface will 
basically only work if you already have CGI support on your server. If you don't, 
