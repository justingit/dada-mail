...
If the included simple date tags are not enough, Dada Mail has support for C<strftime> formatting using the CPAN Module, C<Time::Piece>
...
To use this in Dada Mail's templating syntax, use the C<E<lt>!-- tmpl_time_piece --E<gt> tag, like this: 
