...
You'll know you're working with a list-specific attribute, as the tag will start out with: C<E<lt>!-- tmpl_var list_settings.>. Notice the dot, C<.> at the end. 

The tag will then be proceeded with the attribute you want to use and end with, C<--E<gt>>
