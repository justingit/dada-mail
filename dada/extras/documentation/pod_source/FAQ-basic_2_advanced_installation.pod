...
For many reasons, you may want to upgrade, while also switching a Basic Installation to an Advanced Installation. A big reason being, since v4.2.0 of Dada Mail, 
we don't recommend performing a basic installation. 
