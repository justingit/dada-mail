...
=head3 "Send a Message" API

The API used in the, "Send a Message" screen has been introduced in an... introductory manner, in the, I<Integrating Dada Mail into other Programs> docs: 
...
There are now messages on top of the, Send a Message, Send a Webpage and Send a List Invitation screens to let you know if the limit of 
