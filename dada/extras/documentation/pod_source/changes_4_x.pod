...
that features the same refined user interface. The data can now be sorted alphabetically, ascending or descending by email address or by any of the profile fields.

Individual subscribers can now be more easily administrated. From each subscriber's membership screen, you can see all the 
sublists an individual address is a member of and move the address to and from. A running history of the addresses membership is
also available. 
...
L<http://dadamailproject.com/support/documentation/features-html_template_pro.pod.html>
...
L<http://dadamailproject.com/support/documentation/features-email_template_syntax.pod#date_related_tags>
...
L<http://dadamailproject.com/support/documentation/FAQ-general.pod.html#tuning_dada_mail_to_send_mass_mailings_faster>
...
=head3 <form> tags have no, 'accept-charset="..."' paramater
...
=head3 Library error in dada_clickthrough_plaintext2sql.pl
...
use Pro Dada, if you need more than that: L<http://dadamailproject.com/purchase/pro.html>
...
=head3 ajax_include_subscribe.cgi - set the mailing list you want the form to use, by query string paramater
...
You may now set whichever list you would like the subscription form to use, via the, C<list> query string paramater: 
...
L<http://dadamailproject.com/d/move_dada_mail.pod.html>
...
add a list of the errors it came across by passing them in query string with a paramater named, C<errors>. 
...
http://dadamailproject.com/support/documentation/basic_to_contemporary_installation.pod.html
