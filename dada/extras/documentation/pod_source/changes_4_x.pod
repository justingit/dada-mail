...
This release is currently in ALPHA and there are many unknown bugs. Probably. 

=head2 Summary 4.9.0

This release focuses on many parts of Dada Mail to enhance performance: 
...
with Dada Mail (C<HTML::Template>). C<HTML::Template::Pro> will need to be installed seperately. 
...
will have to install C<LWP> yourself. 
