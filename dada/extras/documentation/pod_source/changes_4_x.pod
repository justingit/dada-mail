...
=head2 Summary 4.7.0 alpha 1

... 

=head2 Bug Fixes 4.7.0 alpha 1

I<Pending merge w/B<bugfixes-4_6_2> branch>

=head2 Features 4.7.0 alpha 1
...
Mailing List can now be truly, I<Invitation-Only>. The list owner of a mailing list must send out an Invitation Message from the list control panel and individuals may not self-subscribe. 
...
This farewell message can be customized in the list control panel in the, B<Appearance and Templates - Email Message Templates> screen under, B<Subscribed by List Owner Message> I<(Should be simply, Welcome from List Owner message?)>
...
This welcome message can be customized in the list control panel in the, B<Appearance and Templates - Email Message Templates> screen under, B<Unsubscribed by List Owner Message>
