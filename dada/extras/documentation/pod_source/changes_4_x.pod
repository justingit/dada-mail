...
With this version, you know have the ability to: 
...
=item * View mass mailing tracker information from right within the mailing monitor I< (opens, link clickthroughs, bounces, forward-to-a-friend, arvhive views, etc)>
...
but was moved to, B<Your Mailing List - Mailing List Options> under, B<List Control Panel Subscriptions>. The option has been relabled, B<Enable Adding Subscribers from the List Control Panel>
