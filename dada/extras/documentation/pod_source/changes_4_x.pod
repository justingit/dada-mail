...
4.0.5 should provide a fix for this problem, B<BUT> (big but), 4.0.5 will I<break any 
...
This problem does not impact your List Password, or the Dada Mail Root Password - 
