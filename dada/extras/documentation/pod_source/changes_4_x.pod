...
=head2 Summary 4.6.0 Beta 1

=head2 Features 4.6.0 Beta 1 
...
The installer also gives you the option, when used to upgrade your current Dada Mail, 
to either keep your current C<.dada_config> file, or to create a new C<.dada_config> file, 
while also keeping your current C<.dada_files> directory structure and contents. 

=head2 Changes 4.6.0 Beta 1 
