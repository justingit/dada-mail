...
=head2 Summary 4.6.0 Alpha 2

v4.6.0  introduces Amazon SES support. This allows you to send email 
messages with Dada Mail using the Amazon SES Web Service. This feature is currently labeled, 
I<Experimental>. 

=head3 See Also: 

L<http://dadamailproject.com/support/documentation/features-amazon_ses_support.pod.html>

=head2 Features 4.6.0 Alpha 2 
