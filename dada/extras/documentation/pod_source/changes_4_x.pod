...
=head2 Summary 4.6.0 Beta 2

=head2 Features 4.6.0 Beta 2 

=head2 New Experimental Feature: controlling the behavior of the List Unsubscribe Link

You can now set the behavior of Dada Mail, after a user clicks the Unsubscriber Link. 

The unsubscription request can either be automatically processed, 

or you may have the subscriber submit a unsubscription form. 

The second option is hoped to thwart absent-minded clicks, as well as auto link prefetching. 

This feature is currently labeled, I<Experimental>. 

=head3 New Plugin: Mailing Monitor

The, B<Mailing Monitor> plugin replaces the, C<auto_pickup.pl> extension, has a nicer list control panel interface and much more simplified instructions. 
...
SES Web Service. This feature is currently labeled, I<Experimental>. 
...
It's now easier to write in a, "Forward to a Friend" feature in your messages. 

=head4 More Information: 

L<http://dadamailproject.com/d/features_forward_to_a_friend.pod.html>

=head3 Installer Enhancements
...
=head2 Changes 4.6.0 Beta 2 

=head3 Default Mailing List Message Templates

The default mailing list message templates have been changed to be less verbose 
and to include the "Forward to a Friend" link
