...
=head3 '=' added to the end of some plaintext mailins in quoted-printable encoding
...
=head3 Unsubscribe requrests should have similar "notify via email, rather than web UI" functionality
