...
=head3 New Plugin: Sending Monitor

The, B<Sending Monitor> plugin replaces the, C<auto_pickup.pl> extension, has a nicer list control panel interface and much more simplified instructions. 
