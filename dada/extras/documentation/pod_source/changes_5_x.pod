...
This release of Dada Mail features the support for a new WYSIWYG editor, TinyMCE, as well as support for a new file browser called, KCFInder. All three supported WYSIWYG editors (FCKeditor, CKeditor, Tiny MCE), 
as well as KCFinder are bundled with Dada Mail and can be installed and configured within the Dada Mail Installer, without any additional work needed. 
...
=head3 Dada Mail Installer Support 
...
Dada Mail now allows you to toggle between the 
