...
Dada Mail, version 3.0.x will work for Dada Mail 3.1: 
...
and then run the 3.0 to 3.1 migration utility: 

L<http://dadamailproject.com/support/documentation/dada_3_to_dada_3.1_sql.pl>

You will also want to read through the 3.0 to 3.1 API/Configuration docs: 
