...
http://dadamailproject.com/support/documentation/changes_4_x.pod.html
...
L<http://dadamailproject.com/support/documentation/dada3_to_dada4.pod.html>
...
=head3 SQL variables - make sure to set them!
