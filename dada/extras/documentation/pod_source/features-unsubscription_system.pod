...
=head1 Dada Mail's Unsunscription System

=head1 Introduction

Having a reliable, easy-to-use Unsubscription/Removal system is essential for any healthy mailing list system. Dada Mail's unsubsription system should prove to be both

=head1 Essential Things You Need to Know

=head2 ALWAYS Have an Unsubscription Link Present in Your Mailing List Messages

As well as required to conform to US laws dealing with runing a mailing list, the unsubscription link allows a subscribe to remove themselves from your mailing list, without any intervention from the List Owner, saving everyone time. 

=head2 The Unsubscription Link

In Dada Mail, a unique Unsubscription Link is generated automatically by Dada Mail. It looks like this: 
...
Usually, the unsubscription link will be found in the B<footer> of your mailing list message. To make things easy, Dada Mail allows you to sent a simple mailing list message template, that allows you to set your own footer. By default, Dada Mail already makes a footer for you, with the unsubscription link present.
...
You can customize your Mailing List Message template in the List Control Panel, under B<Appearance and Templates Email Message Templates>
...
If a subsriber would like to remove themselves from your mailing list, they will only have to click on the unsubscription link, located in your newsletter. 
...
One the email address is entered, and the form submitted - that's it: the user is unsubscribed from your mailing list. 
