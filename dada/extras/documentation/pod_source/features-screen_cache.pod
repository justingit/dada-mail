...
Removing this directory is save to do. If enabled, the cache will be re-created. 
...
be automatically flused of any files, to be re-created again. 

If you are working on a new list-wide or installation-wide design for Dada Mail, 
it could be helpful to temporarily disable Screen Caching, until your all set with your 
design. 
