...
For each editor's parameters (C<fckeditor>, C<ckeditor>, C<tiny_mce>), there are two more named parameters, C<enabled> and, C<url>. 
...
I<dada/installer-disabled/templates/tiny_mce_config_js.tmpl>
...
I<dada/installer-disabled/templates/fckconfig_js.tmpl>
