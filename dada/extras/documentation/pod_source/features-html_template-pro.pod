...
=head1 Installing HTML::Template::Pro
...
=head1 Configuring Dada Mail to use HTML::Template::Pro
...
L<http://dadamailproject.com/d/Config.pm.html#_template_settings>, specifically, the, C<engine> parameter. 
