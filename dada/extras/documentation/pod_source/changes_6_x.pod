...
Previous versions of Dada Mail were specifically designed to run B<Public> Mailing Lists: mailing lists where usually anyone can subscribe to, and most I<definitely> everyone can remove themselves from (unsubscribe). 
...
When a mailing list is set to, B<Private>, unsubscription links are not required (as they are in a public mailing list), but any unsubscription links will be turned into a link to B<Request Removal>. This request will go to the List Owner, who will have the final say on who is removed from the mailing list. 
