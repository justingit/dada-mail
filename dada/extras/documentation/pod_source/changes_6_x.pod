...
Dada Mail can now save a Draft message right in the, "Send a Message", or "Send a Wepage" screen. Messages are also auto-saved automatically every minute, in case your browser window inadvertantly is closed by accident. Draft messages will also be saved automatically, whenever you send out a test mass mailing. 
...
All form fields available to you in the, "Send a Message", and "Send a Webpage" screen are saved, when a draft is saved, including message headers, message body, as well as Archive Options Partial Mailing List Sending Options, File Attachments, and Testing Options. 
...
Attachments can now also be removed from your message easily. 
