...
Login into your list and go to: B<Your Mailing List -Mailing List Options>

Under the heading, B<List Control Panel Subscriptions> check the option, B<Enable Adding Subscribers from the List Control Panel> 
