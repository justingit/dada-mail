...
Running a public list requires you to have a way to unsubcribe from your mailing list and Dada Mail requires that every message you send in a mass mailing contain a unsubscription link - including discussion messages. 
...
Dada Mail has an in-program policy of requiring the unsubscription link to be prsent  in all messages sent in a mass mailing. This is to stop blatant abuse of the program, but we also  do sincerely suggest this as a best practice when using the program. If an unsubscribe link is not found 
...
Email messages are controlled per list. In the list control, go to: B<Mail Settings - Advanced Options> and select the charset you'd like to use under, B<Default Character Set of Mailings>
