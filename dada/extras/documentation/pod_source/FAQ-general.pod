...
Create a new image around 175 x 75 px (if you want to match the size of what's currently be used). Save it as, "dada_mail_logo.png"

Place it in the, I<dada/DADA/Template/templates> directory. 

I<Or> place it in your I<.dada_files/.templates> directory. This copy will override the copy that comes with Dada Mail and any additional upgrades of the script will 
