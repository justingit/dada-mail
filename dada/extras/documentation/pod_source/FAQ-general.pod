...
Log into your mailing list and go to: B<Your Mailing List - Options>
...
This tag will be replaced by an unsubcription link that will be unique to the user's email address, mailing list, and mass mailing that it's sent in. When it's clicked, 
the user will need to simply retype their email address and submit the form presented to them. Once they do that, the user will be removed from the mailing list. 
