...
For example, the included theme is called, C<default>, 
...
=head2 The Sophisticated (by not impossible) Way To Create a New Email Theme
...
L<http://foundation.zurb.com/emails/docs/sass-guide.html>

In a B<separate> directory, you'll want to download the existing Dada Mail default theme from github: 

L<https://github.com/justingit/dada_mail_foundation_email_templates/archive/v10_0_0-alpha1_2016_10_05.tar.gz>
...
Copy these files into the starter Foundation for Emails Project - you'll be overwriting some files from the Foundation starter project, 
...
http://foundation.zurb.com/emails/docs/sass-guide.html#running-the-server

The C<dist> directory contains the files that will correspond to your new email theme. 
