...
Public Mailing Lists are mailing lists that anyone could potentially subscribe to, but B<everyone who is subscribed, no matter what, unsubscribe/remove themselves from>. There's no exceptions to this rule and that cannot be emphasized enough. 
...
Private Mailing Lists may also be B<hidden>, meaning they're not listed anywhere within Dada Mail's public interface. Public mailing lists cannot be hidden (this is a change from past versions, where public mailing lists could have also been hidden).
