...
You can create a scheduled mass mailing in the Send a Message, or Send a Webpage screens. Create your message, and when you're ready, click the button labeled, B<Save as: Schedule>. Scheduled Mass Mailings can also be created from Stationery or a Draft Message.

Your schedule will then be saved, the screen will refresh, and options to activate the schedule, as well as options to set a date and time of your schedule will be shown. 

=head1 Options

=head2 Activate

Check the option when you're ready to have your scheduled mailing go live. If a scheduled mass mailing is not activated, it will not be sent out.
...
A recurring mass mailing will be sent repeatedly, based on the options you've set. You will have to set a start date, and an end date, a time in the day the schedule should go out, and what day you would like it to be sent out on. 
...
Select the days in the week you would like your mass mailing to be sent on. 
...
Once a schedule is saved, you may view and edit them in the list control panel under, B<Mass Mailing - Drafts/Stationery/Schedules>. Click the, B<Schedules> tab to see all your schedules. Click the Subject of your schedule, or click the button labeled, B<Edit...> to further edit your scheduled mass mailing.
...
You may manually check the Scheduled Jobs in the list control panel under, B<App Information - Scheduled Jobs> 
