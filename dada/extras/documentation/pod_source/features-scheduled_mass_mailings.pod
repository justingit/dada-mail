...
You may create a scheduled mass mailing in the B<Send a Message>, and B<Send a Webpage> screens: 

Create your message, and when you're ready, click the button labeled, B<Save as: Schedule>. Scheduled Mass Mailings can also be created from Stationery or from an already existing Draft Message.
...
You may manually check all the Scheduled Jobs in the list control panel under, B<App Information - Scheduled Jobs> 

=head1 System Requirements

Single Mass Mailing Schedules do not have any unique system requirements. 

Recurring Mass Mailing Schedules require the following CPAN Perl Modules: 
...
L<http://dadamailproject.com/d/FAQ-general.pod.html#How-do-you-install-CPAN-Perl-Modules>
