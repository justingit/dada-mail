...
=head1 How Forward to a Friend Works
...
B<Enable CAPTCHA'ing on the, "Forward to a Friend" Form>

=head4 More Information

B<CAPTCHA in Dada Mail:>

L<http://dadamailproject.com/d/global_variables.pod.html#captcha_in_dada_mail>

=head1 Adding a "Forward to a Friend" link to your outgoing mailing list messages
