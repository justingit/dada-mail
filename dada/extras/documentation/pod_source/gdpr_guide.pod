...
If you're upgrading your installation of Dada Mail, here are B<two> things you will definetely want to make sure you: 
...
=head3 Do a Reconfirmation Campaign
...
Data about the subscriber will be shown. A button to export this information is also available. 
...
and it is the prefered interface to use it: 
...
There's no way to enable/disable this anonymizing, 
