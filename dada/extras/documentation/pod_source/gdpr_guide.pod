...
This document explains features and tools built into Dada Mail that may help you and your organization comply with the rules
...
they've agreed in granted to you every point of consent you've asked them for. 
...
=head2 Upgrading Existing Consent Activity Information 
...
If your current mailing list had some sort of history where "confirmed-by-the-user" (via Dada Mail's closed-loop opt-in system) subscriptions was not required, 
