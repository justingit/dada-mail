...
Dada Mail's, "Send a List Message", or "Send a Webpage" screens to more than one 
...
Multiple Mailing List Sending is currently available in the, "Send a List Message" and "Send a Webpage" screens. 
...
so if your host list using SMTP sending, you're entire mailing will use SMTP sending. 
...
a subscriber will be sent from. Because of that, it's highly recommended, you never use this 
...
Because of this, the messages will appear and actually be from each list you want to send to. 
