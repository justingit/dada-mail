...
Entire screens may be disabled, when someone logs in, using the List Password. But, these screens will always be available, when you log into a mailing list, using the Dada Mail Root Password. By default, links to these disabled screens will appear greyed out in the left hand side menu. 

You may change which screens are disabled right in the List Control Panel, under, B<Your List Control Panel - Enable/Disable Features> - make sure to first log into the mailing list with the Dada Mail Root Password! 
...
=item * Your Mailing List - Options

B<Your Mailing List - Options> contains options on some of the advanced behaviors of the mailing list, including options on how people can be subscribed to your list, and what mode you are going to run your mailing list as (private list, public list). 
...
=item * Your Mailing List - Delete This Mailing List

=item * Your List Control Panel

=item * Your List Control Panel - Enable/Disable Features

=item * Your List Control Panel - Options
