...
You may change which screens are disabled right in the List Control Panel, under, B<Your List Control Panel - Customize Feature Set> - make sure to first log into the mailing list with the Dada Mail Root Password! 
...
=item * Your List Control Panel - Customize Feature Set
