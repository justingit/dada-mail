...
Here's the direct download to Dada Mail v6.5.0 Alpha 2:

L<http://dadamail.googlecode.com/files/dada-6_5_0-alpha2.tar.gz>
...
=head1 Step #2 Upload the, "dada-6_5_0-alpha2.tar.gz" distro into your cgi-bin

Once you download the C<dada-6_5_0-alpha2.tar.gz> distro (you will B<not> have to uncompress the distribution), upload it to your hosting account's I<cgi-bin>.
...
<ul>
<li><strong><a href="https://raw.github.com/justingit/dada-mail/v6_5_0-alpha1_2013_06_11/uncompress_dada.cgi">uncompress_dada.cgi</a> (Save Page/Link As...)</strong></li></ul>

=end html

and upload this script (PlainTest/ASCII mode - NOT binary!) to your hosting account's I<cgi-bin> directory - right alongside the I<dada-6_5_0-alpha2.tar.gz> distro you just put up. 
...
The, C<uncompress_dada.cgi> should attempt to uncompress the I<dada-6_5_0-alpha2.tar.gz> distro, change the necessary permissions of various files and prep the actual installer for you to use. 
...
<pre>
Can't find dada-6_5_0-alpha2.tar to uncompress!
...
=head2 Amazon SES (Optional)

Optionally, you may set up Dada Mail to send via Amazon's Simple Email Service. This is a third party email sending service, which may have a much higher daily email quota and sending rate than what may be allowed on your own hosting account. Amazon SES does charge a fairly low rate for their service (about $0.10 per thousand messages sent). For more information, see the Amazon SES own site (L<http://aws.amazon.com/ses/>) and Dada Mail's docs on Amazon SES (L<http://dadamailproject.com/d/features-amazon_ses_support.pod.html>)
...
=head1 Making Additional Global Configuration Changes using the Dada Mail Installer

Along with Installing Dada Mail, the Dada Mail Installer can also help reconfigure the global configuration of Dada Mail, at any time in the future, after your installation. To do this, you will need to: 
