...
Here's the direct download to Dada Mail v5.0.2 

L<https://github.com/downloads/justingit/dada-mail/dada-5_0_2.tar.gz>
...
=head1 Step #2 Upload the, "dada-5_0_2.tar.gz" distro to your cgi-bin

Download the C<dada-5_0_2.tar.gz> distro (you will B<not> have to uncompress the distribution) and then upload it to your hosting account's I<cgi-bin>.
...
<ul>
<li><strong><a href="https://github.com/justingit/dada-mail/raw/v5_0_2-stable_2012_04_22/uncompress_dada.cgi">uncompress_dada.cgi</a> (Save Page/Link As...)</strong></li></ul>

=end html

and upload this script (PlainTest/ASCII mode - NOT binary!) to your hosting account's I<cgi-bin> - right alongside the I<dada-5_0_2.tar.gz> distro you just put up. 
...
The, C<uncompress_dada.cgi> should attempt to uncompress the I<dada-5_0_2.tar.gz> distro, change the necessary permissions of various files and prep the actual installer for you to use. 
...
<pre>
Can't find dada-5_0_2.tar to uncompress!
