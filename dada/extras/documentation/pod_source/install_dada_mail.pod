...
does supportt more global configuration options. You can drop back into the installer later in a couple of different ways, if you would rather get up and running now.
