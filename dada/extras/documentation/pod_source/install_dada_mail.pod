...
<p>
    <li>
    <a href="https://sourceforge.net/projects/dadamail/files/dada-8_0_0-alpha3.tar.gz/download">
        Click here to download to Dada Mail v8.0.0 Alpha 3
    </a> 
    </li>
    <li>
    Or, if you're a Pro Dada Subscriber, 
    <a href="http://dadamailproject.com/pro_dada">
        click here to download to Pro Dada v8.0.0 Alpha 3
    </a>
    </li>
</ul>
</p>
...
I<When installing Pro Dada, use, B<pro_dada-8_0_0-alpha3.tar.gz> as the name of the distribution, in these directions.>


=head2 Step #2 Upload the, "dada-8_0_0-alpha3.tar.gz" distro into your cgi-bin

Once you downloaded the C<dada-8_0_0-alpha3.tar.gz> distro, upload it to your hosting account's I<cgi-bin>.
...
For many things in Dada Mail, including making sure your mass mailings are going out correctly, you will need to set up the scheduled jobs.
