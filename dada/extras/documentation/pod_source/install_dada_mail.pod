...
<div class="row">
	<div class="small-12 medium-8 large-8 medium-centered large-centered columns">	
		<a 
			...
			target="_blank"
			href="https://sourceforge.net/projects/dadamail/files/dada-11_0_0.tar.gz/download">
	        Download Dada Mail, v11.0.0
		</a> 
...
I<When installing Pro Dada, use B<I<pro_>dada-11_0_0.v11_0_0-stable_2018_05_21> as the name of the distribution in these directions.>

=head3 Upload the Dada Mail distribution

Once you have downloaded the Dada Mail distribution ( C<dada-11_0_0.tar.gz>v11_0_0-stable_2018_05_21oad it to your hosting account. 
...
<a 
	class="button success expand" 
	target="_blank"
	href="https://raw.github.com/justingit/dada-mail/v11_0_0-stable_2018_05v11_0_0-stable_2018_05_21compress_dada.cgi"
>
	uncompress_dada.cgi for v10.0.0 Alpha (Save Page/Link As...)
</a>

=end html

and upload the C<uncompress_dada.cgi> script (PlainTest/ASCII mode - NOT binary!) to the same directory in your hosting account that you just uploaded, I<dada-11_0_0.tar.gz>. 

=hev11_0_0-stable_2018_05_21ange the file permissions of the helper script to, "755"

=head3 Visit the helper script in your web browser

Visiting the C<uncompress_dada.cgi> script should attempt to uncompress the I<dada-11_0_0.tar.gz> distrov11_0_0-stable_2018_05_21ge the necessary permissions of various files and prep the actual installer for you to use. 
...
<pre>Can't find dada-11_0_0.tar to uncomprv11_0_0-stable_2018_05_21 You may have to uncompress and prep Dada Mail manually.</pre> 
...
More Information: Installing CPAN Perl Modules L<http://dadamailproject.com/d/FAQ-installing_CPAN_Perl_modules.pod.html>
...
It itself can be installed using the Dada Mail installer, and should be installed, by default. 

You may access it in the List Control Panel under, B<Plugins>. 
Make sure you have logged into a mailing list with the Dada Mail Root Password,
