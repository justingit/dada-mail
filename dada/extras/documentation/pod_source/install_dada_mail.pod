...
Here's the direct download to Dada Mail v8.0.0 Alpha 2:

L<https://sourceforge.net/projects/dadamail/files/dada-8_0_0-alpha2.tar.gz/download>
...
More information about B<Pro Dada>: 

L<http://dadamailproject.com/purchase/pro.html> 

=head2 Step #2 Upload the, "dada-8_0_0-alpha2.tar.gz" distro into your cgi-bin

Once you download the C<dada-8_0_0-alpha2.tar.gz> distro, upload it to your hosting account's I<cgi-bin>. For Pro Dada users, this distro is named, C<pro_dada-8_0_0-alpha2.tar.gz> - use that name for the rest of the directions, below. 
...
<ul>
<li><strong><a href="https://raw.github.com/justingit/dada-mail/v8_0_0-alpha2_2015_02_20/uncompress_dada.cgi">uncompress_dada.cgi</a> (Save Page/Link As...)</strong></li></ul>

=end html

and upload this script (PlainTest/ASCII mode - NOT binary!) to your hosting account's I<cgi-bin> directory - right alongside the I<dada-8_0_0-alpha2.tar.gz> distro you just put up. 
...
The, C<uncompress_dada.cgi> should attempt to uncompress the I<dada-8_0_0-alpha2.tar.gz> distro, change the necessary permissions of various files and prep the actual installer for you to use. 
...
<pre>
Can't find dada-8_0_0-alpha2.tar to uncompress!
...
=head2 Setup the Scheduled Jobs (cronjobs)

For many things in Dada Mail, including making sure your mass mailings are going out correctly, you will need to set up the scheduled jobs - this is usually done by setting a new cronjob. The command for the cronjob will be presented to you. Here's more information on the scheduled job needed: 
...
L<http://dadamailproject.com/support/documentation/install_dada-cl.pod.html>

most of the options available on the web-based interface are available in the command line interface.
