...
Here's the direct download to Dada Mail v4.3.0 Beta 2: 

L<https://github.com/downloads/justingit/dada-mail/dada-4_3_0-beta2.tar.gz>

=cut

	(If you have Pro Dada, you can download v4.3.0 of Pro Dada here:)

	L<http://dadamailproject.com/pro_dada/index.cgi?rm=download_file&filename=pro_dada-4_3_0.tar.gz>
...
CHANGE
=for html <ul><li><strong><a href="https://github.com/justingit/dada-mail/raw/739af18c9377d777cbc1bb9b3836a3622cab5b03/uncompress_dada.cgi">uncompress_dada.cgi</a> (Save Page/Link As...)</strong></li></ul>
