...
<div class="see_also">
<p>
 In these directions we suggest the <code>cgi-bin</code>, but feel free to use any directory that you <strong>know</strong> will work. See also: <a href="./FAQ-install_upgrade.pod#fix_me">Installing Dada Mail in a directory other than in your, &quot;cgi-bin&quot;</a>
</p>
</div>
...
<ul>
<li><strong><a href="https://github.com/justingit/dada-mail/raw/v4_9_1-beta1_2011_12_18/uncompress_dada.cgi">uncompress_dada.cgi</a> (Save Page/Link As...)</strong></li></ul>
...
<p>See, <a href="./FAQ-install_upgrade#prepping_dada_mail_manually">Prepping Dada Mail Manually</a> if this doesn't happen and you get a message in your browser window, sort of like this: </p>
