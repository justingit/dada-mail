...
<div class="row">
	<div class="small-12 medium-8 large-8 medium-centered large-centered columns">	
		<a 
			...
			target="_blank"
			href="https://sourceforge.net/projects/dadamail/files/dada-11_0_0-alpha1.tar.gz/download">
	        Download Dada Mail, v11.0.0 Alpha
		</a> 
...
I<When installing Pro Dada, use B<I<pro_>dada-11_0_0-alpha1.tar.gz> as the name of the distribution in these directions.>

=head3 Upload the Dada Mail distribution

Once you have downloaded the Dada Mail distribution ( C<dada-11_0_0-alpha1.tar.gz>), upload it to your hosting account. 
...
<a 
	class="button success expand" 
	target="_blank"
	href="https://raw.github.com/justingit/dada-mail/v11_0_0-alpha1_2018_05_17/uncompress_dada.cgi"
>
...
Visiting the C<uncompress_dada.cgi> script should attempt to uncompress the I<dada-11_0_0.tar.gz> distro, change the necessary permissions of various files and prep the actual installer for you to use. 
...
<pre>Can't find dada-11_0_0-alpha1.tar to uncompress!
