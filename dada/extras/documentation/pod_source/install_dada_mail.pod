...
Here's the direct download to Dada Mail v4.9.1: 

L<https://github.com/downloads/justingit/dada-mail/dada-4_9_1-beta1.tar.gz>
...
=head1 Step #2 Upload the, "dada-4_9_1-beta1.tar.gz" distro to your cgi-bin

Download the C<dada-4_9_1-beta1.tar.gz> distro (you will B<not> have to uncompress the distribution) and then upload it to your hosting account's I<cgi-bin>.
...
=for html <ul><li><strong><a href="https://github.com/justingit/dada-mail/raw/v4_9_1-beta1_2011_12_18/uncompress_dada.cgi">uncompress_dada.cgi</a> (Save Page/Link As...)</strong></li></ul>

and upload this script (PlainTest/ASCII mode - NOT binary!) to your hosting account's I<cgi-bin> - right alongside the I<dada-4_9_1-beta1.tar.gz> distro you just put up. 
...
The, C<uncompress_dada.cgi> should attempt to uncompress the I<dada-4_9_1-beta1.tar.gz> distro, change the necessary permissions of various files and prep the actual installer for you to use. 
...
If this doesn't happen and you get a message in your browser window, sort of like this: 

	Can't find dada-4_9_1-beta1.tar to uncompress!
	You may have to uncompress and prep Dada Mail manually.

Try using the, B<Prepping Dada Mail Manually> instructions, below. 
...
B<How to Download, Install and Configure Dada Mail v4.9.1>

=for html <p><iframe width="853" height="510" src="http://www.youtube.com/embed/MWz8O13yc0s?hd=1" frameborder="0" allowfullscreen></iframe></p>

=head1 Prepping Dada Mail Manually

If the, B<uncompress_dada.cgi> script fails to uncompress the Dada Mail distro, you may have to a few steps, yourself. This usually is because the C<gunzip> utility just isn't available to whatever is running the helper script. Shucks. 
...
=head2 Visit the, dada/installer/install.cgi script in your web browser

The, C<install.cgi> script should take over from there.

You can now jump back to the instructions above at, B<Configuring Dada Mail with the, "install.cgi" Script >
