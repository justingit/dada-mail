...
Here's the direct download to Dada Mail v7.1.1:

L<https://sourceforge.net/projects/dadamail/files/dada-7_1_1.tar.gz/download>
...
=head2 Step #2 Upload the, "dada-7_1_1.tar.gz" distro into your cgi-bin

Once you download the C<dada-7_1_1.tar.gz> distro, upload it to your hosting account's I<cgi-bin>. For Pro Dada users, this distro is named, C<pro_dada-7_1_1.tar.gz> - use that name for the rest of the directions, below. 
...
<ul>
<li><strong><a href="https://raw.github.com/justingit/dada-mail/v7_1_1-stable_2014_07_11/uncompress_dada.cgi">uncompress_dada.cgi</a> (Save Page/Link As...)</strong></li></ul>

=end html

and upload this script (PlainTest/ASCII mode - NOT binary!) to your hosting account's I<cgi-bin> directory - right alongside the I<dada-7_1_1.tar.gz> distro you just put up. 
...
The, C<uncompress_dada.cgi> should attempt to uncompress the I<dada-7_1_1.tar.gz> distro, change the necessary permissions of various files and prep the actual installer for you to use. 
...
<pre>
Can't find dada-7_1_1.tar to uncompress!
