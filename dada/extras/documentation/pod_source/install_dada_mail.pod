...
Here's the direct download to Dada Mail v4.8.4 Beta 1: 

L<https://github.com/downloads/justingit/dada-mail/dada-4_8_4-beta1.tar.gz>
...
=head1 Step #2 Upload the, "dada-4_8_4-beta1.tar.gz" distro to your cgi-bin

Download the C<dada-4_8_4-beta1.tar.gz> distro (you will B<not> have to uncompress the distribution) and then upload it to your hosting account's I<cgi-bin>.
...
=for html <ul><li><strong><a href="https://github.com/justingit/dada-mail/raw/v4_8_4-stable_2011_10_25/uncompress_dada.cgi">uncompress_dada.cgi</a> (Save Page/Link As...)</strong></li></ul>

and upload this script (PlainTest/ASCII mode - NOT binary!) to your hosting account's I<cgi-bin> - right alongside the I<dada-4_8_4-beta1.tar.gz> distro you just put up. 
...
The, C<uncompress_dada.cgi> should attempt to uncompress the I<dada-4_8_4-beta1.tar.gz> distro, change the necessary permissions of various files and prep the actual installer for you to use. 
...
B<How to Download, Install and Configure Dada Mail v4.8.4>
