...
<div class="row">
	<div class="small-12 medium-8 large-8 medium-centered large-centered columns">	
		<a 
			...
			target="_blank"
			href="https://sourceforge.net/projects/dadamail/files/dada-11_14_1.tar.gz/download">
	        Download Dada Mail, v11.14.1
		</a> 
...
I<When installing Pro Dada, use B<I<pro_dada-11_14_1.tar.gz>> as the name of the distribution in these directions.>

=head3 Upload the Dada Mail distribution

Once you have downloaded the Dada Mail distribution ( C<dada-11_14_1.tar.gz>, upload it to your hosting account.
...
<a 
	class="button success expand" 
	target="_blank"
	href="https://raw.github.com/justingit/dada-mail/v11_14_1-stable_2020_06_09/uncompress_dada.cgi"
>
	uncompress_dada.cgi for v11.14.1 (Save Page/Link As...)
</a>

=end html

and upload the C<uncompress_dada.cgi> script (PlainText/ASCII mode - NOT binary!) to the same directory in your hosting account that you just uploaded, I<dada-11_14_1.tar.gz>. 

=head3 Change the file permissions of the helper script to, "755"

=head3 Visit the helper script in your web browser

Visiting the C<uncompress_dada.cgi> script should attempt to uncompress the I<dada-11_14_1.tar.gz> and change the necessary permissions of various files and prep the actual installer for you to use. 
...
<pre>Can't find dada-11_14_1.tar to uncompress! You may have to uncompress and prep Dada Mail manually.</pre> 
