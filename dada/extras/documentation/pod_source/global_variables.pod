...
L<https://dadamailproject.com/d/features-profiles.pod.html>
...
C<$ADMIN_MENU> holds a complex data structure that represents the admin menu, 
...
C<-Title> holds the name of a section of the admin menu, for exaple, "Mass Mailing"
...
into a mailing list with the B<Dada Mail Root Password> and navigate to, B<Control Panel Settings - Enable/Disable Features>. 
...
L<https://dadamailproject.com/d/FAQ-errors.pod.html#_debug_trace___making_dada_mail_s_own_modules_more_verbose>
...
L<https://dadamailproject.com/d/FAQ-errors.pod.html#tracing_cpan_modules_with__cpan_debug_settings>
...
L<https://dadamailproject.com/installation/using_dada_mail.html>
...
L<https://dadamailproject.com/d/FAQ-general.pod.html.html#is_there_a_way_to_speed_up_screen_rendering__how_to_use_the_screen_cache_>
...
When a user clicks the, "Logout" link on admin menu of the control panel, they'll 
