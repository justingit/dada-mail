...
And you have a mailing monitor running, without any extra scripts to installed. It may also be convenient, if you want the mailing monitor that the C<mailing_monitor.cgi> plugin provides, but you don't have access to, or don't know how to set a cronjob. 
