...
=head4 Manual Installation 

If you do not want to use the new installer, we will still suggest still the Manual Installation instructions: 

L<http://dadamailproject.com/installation/installation_advanced.html>

The installer basically automates a lot of what you need to do with the Manual Installation. 

B<NOTE:> This method used to be called the, B<Advanced Installation>. 
...
L<http://github.com/downloads/justingit/dada-mail/dada-4_2_0-rc1.tar.gz>
...
L<http://github.com/justingit/dada-mail/raw/ecd80c6e8261e12531cccbf3bb2b9783baafa09a/uncompress_dada.cgi>
