...
Every single instance of the subscription form is handled by one template file, living in the dada/templates directory called, C<subscription_form_widget.tmpl>. Changes to this file will affect every instance of the subscription form in the program. 
