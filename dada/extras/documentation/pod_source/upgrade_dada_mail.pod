...
<div class="see_also">
<p> For information on how to upgrade Dada Mail from an install that wasn't done using the inclused Dada Mail Installer, see, <a href="./FAQ-install_upgrade.pod.html##upgrading_dada_mail_from_different_installation_types>Upgrading Dada Mail From Different Installation Types</a></p>
</div> 

=end html

=head1 Step #1 Rename the, "dada" Directory
...
Select this option if you are B<upgrading between major versions> of Dada Mail. For example, version B<5>.0.0 to version B<6>.0.0 or, 
from version 6.B<0>.0 to version 6.B<2>.0. 

=head3 Why Create a new .dada_config file? 
...
Changelog: L<http://dadamailproject.com/d/changes_6_x.pod.html>
