...
L<http://dadamailproject.com/support/documentation/FAQ-general.pod.html.html>
...
C<Net::SMTP_auth> is a little more flexible than C<Net::SMTP> when it comes to setting the authentication schemes to use and Mail::Bulkmail does not support SASL authentication at all, has some mysterious bugs we couldn't figure out and Dada Mail does much of the rest of the utilities that it packs. 
...
L<http://dadamailproject.com/support/documentation/bounce_handler.html>
