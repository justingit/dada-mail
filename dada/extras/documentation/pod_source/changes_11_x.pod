...
recommended to either upgrade, or to apply the one-line fix seen in this diff: 

L<https://github.com/justingit/dada-mail/commit/95f64f865e4c2c27975f57a265adc9073d15f78c>

This one-line is the only true change between v11.0.4 and v11.0.5. 
