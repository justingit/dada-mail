...
and is still is supported going forward. 
 
reCAPTCHA v2 and v3 can be configured with the included Dada Mail Installer, 
...
Basically this means, if you want some lists to have reCAPTCHA, and others to not, you can. Find the new setting in the list control panel under, 
...
Along with such things as messages opens, clickthroughs, bounces, etc, Dada Mail now tracks and reports the following to help you 
better understand the performance of your mass mailing: 
