...
Files and directories in the, B<dada_mail_support_files> directory are files and directories that are served directly by the webserver. 
Things like images, javascript files, etc, are found here. 
