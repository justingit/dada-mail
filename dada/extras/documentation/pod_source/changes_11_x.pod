...
This is mostly a bug-fix release for issues found in the v11.10.2 release of Dada Mail. The biggest change is the support for v4 AWS Signatures - if you're using Amazon SES to send out messages, be sure to read on for some important information. 
