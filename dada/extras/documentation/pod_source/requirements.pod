...
Dada Mail is tested with MySQL B<5> (v4 will probably work), PostgreSQL B<8> and SQLite B<3>. 

=head1 Configuration

We do ship a web-based installer. It can also I<help> with upgrades. 
