...
Dada Mail is tested with MySQL B<5.6>, PostgreSQL B<8> and SQLite B<3>. We highly suggest using Dada Mail with either MySQL or PostgreSQL, and utilizing he latest versions of either. 
