...
Dada Mail is written in Perl, so you'll want to have Perl, at least version 5.6 for version 3.0.0 and 3.0.1 and Perl version 5.8 for anything above 3.0.1. 
...
There is no auto-installer for Dada Mail that *we* ship. One requirement of Dada Mail, then maybe that you can open up a file in a text editor and make I<extremely simple> changes to it, with regards to file and directory paths on your server. 
