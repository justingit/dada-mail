...
Dada Mail takes full advantage of Foundation's support for Repsonsive Design, especially in the List Control Panel. That means you can more easily and comfortably use Dada Mail on your phone or tablet - the design will adapt to your screen's available real estate. For example: The List Control Panel's left-hand menu will be hidden off-canvas if you're viewing on a phone device, but can be reveal via a hamburger menu on the upper left side of the toolbar menu. 
