...
On the default screen of the Tracker plugin, you'll see a tabl and line graph of basic informaton about the performanc of your mass mailings, allowing you to easily to see trends over time. This data can do be exported per page presented. Look for the link labeled, B<export page (.csv) > to the right of the page navigation. 
...
=item * Limiting double subcription confirmations
