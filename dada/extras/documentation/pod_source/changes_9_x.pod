...
The B<StopForumSpam> service (L<http://stopforumspam.com/>) keeps a list of email addresses, locations, and usernames known to be used for abuse attempts of web apps like forums, blogs, and mailing lists. 
...
This new feature can help stop your mailing list from being abused, curbs the wasting of server resources, and keeps your mailing list cleaner. This integration should I<definitely> be seen as a B<security enhancement>, as these users being marked as abusive are most likely part of a botnet, trying to find vectors for attack. 

This integration of StopForumSpam is currently enabled by default, but it does require the additional installation of a Perl CPAN module named, C<WWW::StopForumSpam>. This module, as well as other CPAN modules can be installed using the following instructions, 
