...
Foundation for Emails (L<http://foundation.zurb.com/emails.html>) is a framework to develop HTML email messages that, "Sucks Less": they're beautiful, responsive, and look correctly in most HTML-capable email readers - even Outlook. 
...
Currently, Dada Mail comes with one email theme and supports additional themes, helping people can create and share their own themes. 
