...
HTML email messages that, "Suck Less": are beautiful, resposive, and look correctly in most HTML-capable 
...
Currently, Dada Mail only comes with one email theme (so ), but 
