...
Dada Mail can transform a RSS Feed into an email message to tbe sent as a mass mailing. Find this option in the list control panel under, 

I<Mass Mailing - Send a Webpage> 

In the I<HTML Version> tab, click the option, 

I<Grab content from a RSS/Atom feed>
