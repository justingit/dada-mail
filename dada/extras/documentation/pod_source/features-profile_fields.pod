...
Log into the list control panel B<with the Dada Mail Root Password> (very important) to any currently created mailing list. On the left hand menu, under, B<Profiles>, click, B<Profile Fields>
...
You may acquire the HTML code needed to embed the subscription form in a webpage in the usual location: Under B<Appearance and Templates >, click on, B<Subscription Form HTML>. 

=head2 Importing Subscribers

You may mass-import Subscribers to your mailing lists in the list control panel, under: B<Membership - Add/Invite/Subscribe>. Make sure you've I<enabled> mass-import in B<Your Mailing List - Options>, under: 
